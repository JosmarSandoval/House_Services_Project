...
alter system set log_archive_dest_1='LOCATION=/unam-bda/proyecto/d06/archivelogs/RASAPROY MANDATORY' scope=spfile;
alter system set log_archive_dest_2='LOCATION=USE_DB_RECOVERY_FILE_DEST MANDATORY'scope=spfile;
alter system set log_archive_dest_3='LOCATION=/unam-bda/proyecto/d07/archivelogs/RASAPROY' scope=spfile;
